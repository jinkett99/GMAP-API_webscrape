This example notebook demonstrate a simple script and helper functions required to run a Google Map (GMAP) API call to retrieve business websites of the companies listed.
